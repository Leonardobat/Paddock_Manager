...
class Financial_Info(QWidget):
    def __init__(self, data, palette):
        ...
        self.cash = QLabel(data['Cash'])
        self.master = QLabel(data['Sponsor 1']['Name'])
        self.master_value = QLabel(data['Sponsor 1']['Value'])
        self.sponsor1 = QLabel(data['Sponsor 2']['Name'])
        self.sponsor1_value = QLabel(data['Sponsor 2']['Value'])
        self.sponsor2 = QLabel(data['Sponsor 3']['Name'])
        self.sponsor2_value = QLabel(data['Sponsor 3']['Value'])
        self.sponsor3 = QLabel(data['Sponsor 4']['Name'])
        self.sponsor3_value = QLabel(data['Sponsor 4']['Value'])
        self.sponsor4 = QLabel(data['Sponsor 5']['Name'])
        self.sponsor4_value = QLabel(data['Sponsor 5']['Value'])
    ...
    def update_info(self, data: dict):
        self.cash.setText(data['Cash'])
        self.master.setText(data['Sponsor 1']['Name'])
        self.master_value.setText(data['Sponsor 1']['Value'])
        self.sponsor1.setText(data['Sponsor 2']['Name'])
        self.sponsor1_value.setText(data['Sponsor 2']['Value'])
        self.sponsor2.setText(data['Sponsor 3']['Name'])
        self.sponsor2_value.setText(data['Sponsor 3']['Value'])
        self.sponsor3.setText(data['Sponsor 4']['Name'])
        self.sponsor3_value.setText(data['Sponsor 4']['Value'])
        self.sponsor4.setText(data['Sponsor 5']['Name'])
        self.sponsor4_value.setText(data['Sponsor 5']['Value'])